...
while True:
    ...
    if opção == 1: # Jogando 1 v 1
        ...
        jogadores = ler_nome_Jogagores()
        X_OU_O[0] = jogadores[0]
        O_OU_X[0] = jogadores[1]
...
tenha entendido :)''')
        ...
        while True:
            ...
            if verificar_vencedor(*tabuleiro):
                system('clear||cls')
                print(colored('=-'*20, 'blue'))
                print(colored(f'Jogador {jogadores[coint]} VENCEU!'.center(40), 'green'))
                menu(*tabuleiro)
